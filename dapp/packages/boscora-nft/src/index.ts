...
export const ContractErrors = {
  1: { message: "MaxParcelsNotSet" },
  2: { message: "OwnerNotSet" },
  3: { message: "PaymentTokenNotSet" },
  4: { message: "PriceNotSet" },
  5: { message: "InvalidParcelId" },
  6: { message: "ParcelAlreadyDonated" },
  7: { message: "OracleAddressNotSet" },
  8: { message: "MetricsNotFound" },
  9: { message: "NoGeoDataFound" },
};
...
export type UpgradeableStorageKey = { tag: "Migrating"; values: void };
...
export type VotesStorageKey =
  ...
  | { tag: "DelegateCheckpoint"; values: readonly [string, u32] }
  | { tag: "NumTotalSupplyCheckpoints"; values: void }
  | { tag: "TotalSupplyCheckpoint"; values: readonly [u32] }
...
export type TimelockStorageKey =
  ...
  | { tag: "OperationLedger"; values: readonly [Buffer] };
...
export interface Client {
   ...
   */
  mint: (
    { to, parcels }: { to: string; parcels: Array<ParcelRequest> },
  ...
  /**
   * Construct and simulate a geo_coordinates transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Getter for parcel coordinates.
   */
  geo_coordinates: (
    { token_id }: { token_id: u32 },
    options?: MethodOptions,
  ) => Promise<AssembledTransaction<GeoCoordinates>>;

  /**
   * Construct and simulate a get_live_impact transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Primary function: Query real-time impact data from the Oracle.
   */
  get_live_impact: (
    { token_id }: { token_id: u32 },
    options?: MethodOptions,
  ) => Promise<AssembledTransaction<ImpactMetrics>>;
}
export class Client extends ContractClient {
  static async deploy<T = Client>(
    ...
    return ContractClient.deploy(
      { admin, oracle, max_parcels, payment_token, price },
      options,
    );
  }
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([
        "AAAAAgAAAAAAAAAAAAAAB0RhdGFLZXkAAAAABQAAAAAAAAAAAAAADk9yYWNsZUNvbnRyYWN0AAAAAAABAAAAAAAAAANHZW8AAAAAAQAAAAQAAAAAAAAAAAAAAApNYXhQYXJjZWxzAAAAAAAAAAAAAAAAAAxQYXltZW50VG9rZW4AAAAAAAAAAAAAAAVQcmljZQAAAA==",
        "AAAAAAAAABZNaW50IGEgbmV3IHBhcmNlbCBORlQuAAAAAAAEbWludAAAAAIAAAAAAAAAAnRvAAAAAAATAAAAAAAAAAdwYXJjZWxzAAAAA+oAAAfQAAAADVBhcmNlbFJlcXVlc3QAAAAAAAAA",
        ...
        "AAAAAQAAAAAAAAAAAAAADVBhcmNlbFJlcXVlc3QAAAAAAAACAAAAAAAAAANnZW8AAAAH0AAAAA5HZW9Db29yZGluYXRlcwAAAAAAAAAAAAh0b2tlbl9pZAAAAAQ=",
        "AAAAAQAAAAAAAAAAAAAADkdlb0Nvb3JkaW5hdGVzAAAAAAACAAAAAAAAAAhsYXRpdHVkZQAAAAUAAAAAAAAACWxvbmdpdHVkZQAAAAAAAAU=",
        "AAAAAAAAAAAAAAANX19jb25zdHJ1Y3RvcgAAAAAAAAUAAAAAAAAABWFkbWluAAAAAAAAEwAAAAAAAAAGb3JhY2xlAAAAAAATAAAAAAAAAAttYXhfcGFyY2VscwAAAAAEAAAAAAAAAA1wYXltZW50X3Rva2VuAAAAAAAAEwAAAAAAAAAFcHJpY2UAAAAAAAALAAAAAA==",
        ...
        "",
        ...
        "AAAAAgAAAAAAAAAAAAAAFVVwZ3JhZGVhYmxlU3RvcmFnZUtleQAAAAAAAAEAAAAAAAAAAAAAAAlNaWdyYXRpbmcAAAA=",
  ...
  public readonly fromJSON = {
    ...
    geo_coordinates: this.txFromJSON<GeoCoordinates>,
    get_live_impact: this.txFromJSON<ImpactMetrics>,
  };
}
